<?
	if(isset($_SESSION['name']))
	{
		...
		{			
			...
			if($nameRus != "" && $nameLat != "")
			{
				$result = AddSpecies($idKingdom, $idType, $idClass, $idDetachment, $idFamily, $nameRus, $nameLat);
				
				if(isset($result) && $result != false)
				{
					AddSuccessMessage("Запись о виде успешно добавлена.");
				}
			}
			AddErrors($nameRus, $nameLat);
			
?>
			<script>museum.redirect("Add", "add_species")</script>
<?
		}
	}
?>
<div class='info'>
	<table>
		<tr>
			...
			<td><span class='info__title'>Менеджер экспонатов: добавить вид</span></td>
		</tr>
	</table>
</div>
<?
...
?>
		<form name = "addDetachment" action = "index.php?actionAdd=add_species" method = "POST">
			<div id='form'>
				<fieldset class='form__fieldset'>
				<legend><span class='form__legend'>Добавление вида</span></legend>
				<table>
					<tr class='form__row'>
				...
				?>
					...
					<tr class='form__row'>
						...
						<td><select name = "family" class='form__input'>
				<?
